...
export default function ModernHero() {
  ...
  const tools = [
    ...
    { name: 'SEMrush', image: '/tools/semrush-logo.svg', shape: 'rounded-full' },
    { name: 'Moz Pro', image: '/tools/moz-logo.svg', shape: 'rounded-none' },
    { name: 'Canva Pro', image: '/tools/canva-logo.svg', shape: 'rounded-tl-3xl rounded-br-3xl' },
    { name: 'ChatGPT Plus', image: '/tools/chatgpt-logo.svg', shape: 'rounded-tr-3xl rounded-bl-3xl' },
    { name: 'RunwayML', image: '/tools/runwayml-logo.svg', shape: 'rounded-xl' },
    { name: 'Netflix', image: '/tools/netflix-logo.svg', shape: 'rounded-b-3xl' },
    { name: 'Claude', image: '/tools/claude-logo.svg', shape: 'rounded-2xl' },
    { name: 'Grammarly', image: 'https://img.icons8.com/color/96/grammarly.png', shape: 'rounded-t-3xl' },
    { name: 'Notion', image: 'https://img.icons8.com/fluency/96/notion.png', shape: 'rounded-full' },
    { name: 'Adobe Creative', image: 'https://img.icons8.com/color/96/adobe-creative-cloud.png', shape: 'rounded-none' },
    { name: 'Spotify Premium', image: 'https://img.icons8.com/color/96/spotify.png', shape: 'rounded-tr-3xl rounded-br-3xl' },
    { name: 'Jasper AI', image: 'https://img.icons8.com/color/96/chatgpt.png', shape: 'rounded-3xl' },
    { name: 'Surfer SEO', image: 'https://img.icons8.com/color/96/google-logo.png', shape: 'rounded-t-3xl' },
    { name: 'Mailchimp', image: 'https://img.icons8.com/color/96/email.png', shape: 'rounded-full' },
